    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Ваш пароль був змінений?."
                : message == ManageMessageId.SetPasswordSuccess ? "Пароль заданий."
                : message == ManageMessageId.SetTwoFactorSuccess ? "Настроєний поставщик провірки."
                : message == ManageMessageId.Error ? "Помилка."
        ...
        {
            ViewBag.StatusMessage =
                message == ManageMessageId.RemoveLoginSuccess ? "Зовнішнє і'я входу видалене."
                : message == ManageMessageId.Error ? "Помилка."
                : "";
            var user = await UserManager.FindByIdAsync(User.Identity.GetUserId());
            if (user == null)
